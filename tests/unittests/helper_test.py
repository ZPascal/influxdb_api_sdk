...
class TestSeriesHelper(TestCase):
    ...
    def testSingleSeriesName(self, current_timestamp):
        ...
        TestSeriesHelper.MySeriesHelper(server_name="us.east-1", other_tag="ello", some_stat=159)
        TestSeriesHelper.MySeriesHelper(server_name="us.east-1", other_tag="ello", some_stat=158)
        TestSeriesHelper.MySeriesHelper(server_name="us.east-1", other_tag="ello", some_stat=157)
        TestSeriesHelper.MySeriesHelper(server_name="us.east-1", other_tag="ello", some_stat=156)
        expectation = [
            {
                "measurement": "events.stats.us.east-1",
                "tags": {"other_tag": "ello", "server_name": "us.east-1"},
                "fields": {"some_stat": 159},
                "time": current_date,
            },
            {
                "measurement": "events.stats.us.east-1",
                "tags": {"other_tag": "ello", "server_name": "us.east-1"},
                "fields": {"some_stat": 158},
                "time": current_date,
            },
            {
                "measurement": "events.stats.us.east-1",
                "tags": {"other_tag": "ello", "server_name": "us.east-1"},
                "fields": {"some_stat": 157},
                "time": current_date,
            },
            {
                "measurement": "events.stats.us.east-1",
                "tags": {"other_tag": "ello", "server_name": "us.east-1"},
                "fields": {"some_stat": 156},
                "time": current_date,
            },
        ]
    ...
    def testSeveralSeriesNames(self, current_timestamp):
        ...
        current_timestamp.return_value = current_date = datetime.today()
        TestSeriesHelper.MySeriesHelper(server_name="us.east-1", some_stat=159, other_tag="ello")
        TestSeriesHelper.MySeriesHelper(server_name="fr.paris-10", some_stat=158, other_tag="ello")
        TestSeriesHelper.MySeriesHelper(server_name="lu.lux", some_stat=157, other_tag="ello")
        TestSeriesHelper.MySeriesHelper(server_name="uk.london", some_stat=156, other_tag="ello")
        expectation = [
            {
                "fields": {"some_stat": 157},
                "measurement": "events.stats.lu.lux",
                "tags": {"other_tag": "ello", "server_name": "lu.lux"},
                "time": current_date,
            },
            {
                "fields": {"some_stat": 156},
                "measurement": "events.stats.uk.london",
                "tags": {"other_tag": "ello", "server_name": "uk.london"},
                "time": current_date,
            },
            {
                "fields": {"some_stat": 158},
                "measurement": "events.stats.fr.paris-10",
                "tags": {"other_tag": "ello", "server_name": "fr.paris-10"},
                "time": current_date,
            },
            {
                "fields": {"some_stat": 159},
    ...
    def testSeriesWithoutTimeField(self, current_timestamp):
        ...
        TestSeriesHelper.MySeriesHelper(server_name="us.east-1", other_tag="ello", some_stat=159, time=current_date)
    ...
    def testSeriesWithoutAllTags(self):
        ...
        self.assertRaises(NameError, MyTimeFieldSeriesHelper, **{"server_name": "us.east-1", "some_stat": 158})
    ...
    def testSeriesWithTimeField(self, current_timestamp):
        ...
        MyTimeFieldSeriesHelper(server_name="us.east-1", other_tag="ello", some_stat=159, time=current_date)
    ...
    def testWarnBulkSizeZero(self):  # pragma: no cover
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            self.assertEqual(
                len(w),
                1,
                "{0} call should have generated one warning.".format(WarnBulkSizeZero),
            )
            self.assertIn(
                "forced to 1",
                str(w[-1].message),
    ...
    def testWarnBulkSizeNoEffect(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            self.assertEqual(
                len(user_warnings),
                1,
                "{0} call should have generated one warning.".format(WarnBulkSizeNoEffect),
            )
            self.assertIn(
                "has no affect",
    ...
    def testSeriesWithRetentionPolicy(self):
        ...
        fake_write_points = mock.MagicMock()
        RetentionPolicySeriesHelper(server_name="us.east-1", some_stat=159, other_tag="gg")
        RetentionPolicySeriesHelper._client.write_points = fake_write_points
        RetentionPolicySeriesHelper(server_name="us.east-1", some_stat=158, other_tag="aa")
    ...
    def testSeriesWithoutRetentionPolicy(self):
        ...
        fake_write_points = mock.MagicMock()
        NoRetentionPolicySeriesHelper(server_name="us.east-1", some_stat=159, other_tag="gg")
        NoRetentionPolicySeriesHelper._client.write_points = fake_write_points
        NoRetentionPolicySeriesHelper(server_name="us.east-1", some_stat=158, other_tag="aa")
