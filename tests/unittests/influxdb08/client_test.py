...
class TestInfluxDBClient(unittest.TestCase):
    ...
    def test_write_points_udp(self):
        ...
        self.assertEqual(
            self.dummy_points, json.loads(received_data.decode(), strict=True)
        )
    ...
    def test_add_cluster_admin(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            self.assertDictEqual(
                json.loads(m.last_request.body), {"name": "paul", "password": "laup"}
            )
    ...
    def test_update_cluster_admin_password(self):
        ...
        with requests_mock.Mocker() as m:
            m.register_uri(
                requests_mock.POST, "http://localhost:8086/cluster_admins/paul"
            )
    ...
    def test_add_database_user(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            cli.add_database_user(
                new_username="paul", new_password="laup", permissions=(".*", ".*")
            )
    ...
    def test_alter_database_user_password(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            self.assertDictEqual(
                json.loads(m.last_request.body), {"password": "n3wp4ss!"}
            )
    ...
    def test_alter_database_user_permissions(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            self.assertDictEqual(
                json.loads(m.last_request.body), {"readFrom": "^$", "writeTo": ".*"}
            )
    ...
    def test_alter_database_user_password_and_permissions(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            cli.alter_database_user(
                username="paul", password="n3wp4ss!", permissions=("^$", ".*")
            )
    ...
    def test_update_database_user_password_current_user(self):
        ...
        with requests_mock.Mocker() as m:
            m.register_uri(
                requests_mock.POST, "http://localhost:8086/db/database/users/root"
            )
    ...
    def test_delete_database_user(self):
        ...
        with requests_mock.Mocker() as m:
            m.register_uri(
                requests_mock.DELETE, "http://localhost:8086/db/db/users/paul"
            )
