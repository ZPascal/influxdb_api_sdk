...
class TestLineProtocol(unittest.TestCase):
    ...
    def test_string_val_newline(self):
        ...
        data = {
            "points": [
                {"measurement": "m1", "fields": {"multi_line": "line1\nline1\nline3"}}
            ]
        }

        self.assertEqual(
            line_protocol.make_lines(data), 'm1 multi_line="line1\\nline1\\nline3"\n'
        )
    ...
    def test_tag_value_newline(self):
        ...
        self.assertEqual(
            line_protocol.make_lines(data), 'test,t1=line1\\nline2 val="hello"\n'
        )
    ...
    def test_float_with_long_decimal_fraction_as_type_decimal(self):
        ...
        self.assertEqual(
            line_protocol.make_lines(data), "test float_val=0.8289445733333332\n"
        )
